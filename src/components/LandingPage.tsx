...
function LandingPage() {
    ...
    return (
        <div className='container-fluid'>
            <div className='row'>
                <div className='col-12 headerSection position-relative p-0 d-flex justify-content-center align-items-start'>
                    ...
                    <div className='col-12 d-flex justify-content-between align-items-center'>
                        ...
                        <StyledButton onClick={() => { navigate('/signin'); window.location.reload()}} className='col-3 col-md-1 p-1 me-3 z-3'>Sign In</StyledButton>
                    </div>
                    <div style={{color:'white'}} className='homeSubscription col-md-6 col-10 d-flex flex-column'>
                        <h1 className='col-md-9 col-12'>Unlimited movies, TV shows, and more</h1>
                        ...
                        <form onSubmit={handleSubmitForm} className='col-12 mt-3 d-flex flex-md-row flex-column'>
                            <div className='col-md-8 col-12'>
                                <input
                                className='col-12 rounded py-3 px-2'
                                name='email'
                                type="email"
                            ...
                            <StyledButton type='submit' className='col-md-3 ms-0 mt-3 mt-md-0 p-2 p-md-0 ms-md-2 col-6'>Get Started</StyledButton>
                        </form>
                    </div>
            ...
            <LandingPageWrapSection header='Download your shows to watch offline' paragraph='Save your favorites easily and always have something to watch.' img={MobileWrapperImg} flexWrap='flex-row-md-reverse' />
            ...
            <LandingPageWrapSection header='Create profiles for kids' paragraph='Send kids on adventures with their favorite characters in a space made just for them—free with your membership.' img={kidsImg} flexWrap='flex-row-md-reverse' />
            ...
            <div style={{backgroundColor:'black'}} className='row d-flex justify-content-center'>
                <div className='col-12 d-flex flex-md-row flex-column my-5 '>
                    ...
                    <div className='col-md-3 col-12 mt-3 mt-md-0 d-flex flex-column'>
